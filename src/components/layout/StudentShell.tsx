          ...
          {!backHref && !onMenu ? (
            <>
              ...
              <Box position="relative" ml="auto">
                ...
                <Box position="absolute" top="8px" right="9px" w="6px" h="6px" bg="critical" borderRadius="full" border="1px solid white" />
              </Box>
            </>
          ) : (
            <>
              ...
              <HStack spacing="6px">
                ...
                <Avatar size="xs" name="小芽" bg="brand.100" color="navy.700" icon={<BookOpenText size={15} />} />
              </HStack>
            </>
          )}
        </Flex>
