...
所有產品素材放在 `frontend/public/assets/`，HTML／React 中使用 `/assets/<filename>` 引用。
...
三個 PNG 已檢查 alpha 與四角透明度，並在瀏覽器檢查顯示。最終提示詞記錄於 [docs/reference-asset-prompts.md](../reference-asset-prompts.md)。
